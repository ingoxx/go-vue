...
export const programUpdateRecordDel = (params, method) => post("/assets/program/del?user="+ sessionStorage.getItem("user") +"&token="+sessionStorage.getItem("token"), params, method);
